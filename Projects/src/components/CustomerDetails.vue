<template>
 ...
 <ul class="list-group">
  ...
  <ul class="list-group">
     <li class="list-group-item"><span class="glyphicon glyphicon-euro">{{customer.education}}</span></li>
     <li class="list-group-item"><span class="glyphicon glyphicon-envelope">{{customer.graduationschool}}</span></li>
